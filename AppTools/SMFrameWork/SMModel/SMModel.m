    ...
    for (NSString * key in keys) {
        ...
        if ([object isKindOfClass:[NSArray class]]) {
            ...
            for (NSDictionary * subDict in object) {
                ...
                [model setValuesWithDictionary:subDict classNamesMapper:[modelClass classNameMapper]];
            ...
            Class modelClass = NSClassFromString(mClass);
            SMModel * model = [[modelClass alloc] init];
            [model setValuesWithDictionary:object classNamesMapper:[modelClass classNameMapper]];
